...
- **第4轮**，休斯顿喊"拿一只袜子"，机舱打回重说。这个演示的材料清单**故意不放袜子**，就是为了演示**工具幻觉**：模型喊了一个不存在的东西，运行时把它打回去。（历史小注：真实通话记录里，Kerwin确实提过"湿巾/袜子/揉皱的胶带"当堵旁路孔的备选，机组最后塞的是毛巾；核心"信箱"装置从头到尾不靠袜子）
